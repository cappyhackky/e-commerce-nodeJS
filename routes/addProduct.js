...
router.post('/', upload.single('productImage'), (req, res)=>{
    const {productName, productPrice, productId, productQuantity, productDetail} = req.body;
    const productImage = req.file.filename;
    qry = 'INSERT INTO product VALUES ?;'
    values = [
        [productId, productName, productImage, productPrice, productDetail, productQuantity]
    ]
